...
> warning **Warning** You can't retrieve scoped providers (transient or request-scoped) with the `get()` method. Instead, use the technique described [below](/fundamentals/module-ref#resolving-scoped-providers). Learn how to control scopes [here](/fundamentals/injection-scopes).
