...
To use the repository as a provider dependency in other modules, you will need to export these repositories using the dynamic module generated by `forFeature` method.

```typescript
const DynamicTypeOrmModule = TypeOrmModule.forFeature([AuthorRepository]);
@Module({
