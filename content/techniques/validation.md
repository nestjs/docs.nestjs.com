...
> **Warning** If you are using the `@nestjs/swagger` package see [here](/openapi/mapped-types), while if you use the `@nestjs/grapqhl` package see [here](/graphql/mapped-types)
