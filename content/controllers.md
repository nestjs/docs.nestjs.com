...
> info **Note** For a quickly creating a CRUD contoller with [validation](https://docs.nestjs.com/techniques/validation) you may use the CLI's [CRUD generator](https://docs.nestjs.com/recipes/crud-generator#crud-generator): `nest g resource name`
