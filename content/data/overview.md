...
The Nest team maintains the `@nestjs/typeorm`, `@nestjs/sequelize`, and `@nestjs/mongoose` packages. They add Nest-specific features, such as repository or model injection, testability, and asynchronous configuration.
