...
Looking at the below example code, then you may understand which differences between the `nestia` and `@nestjs/swagger` and what the pure interface DTO type means. Writing the legacy DTO class for the `@nestjs/swagger` for a long time, I feel that "this is insane". 
...
>
> Therefore, just build the SDK through this `nestia` and delivers the SDK. Your client developers would be anticipated from the long time torturing and becom happy. Your solution would be much more reliable and efficient, too.
...
Looking at the [simple/swagger.json](https://github.com/samchon/nestia/tree/master/demo/simple/swagger.json) file, generated by the `nestia`, it seems perfect. Exact route method, path and parameters are constructed and DTO structures are exactly same with the pure interace type `ISaleArticleComment`. Also, comments written on the controller class method, DTO interface `ISaleArticleComment` and its properties are exactly revied on the `description` fields in the `swagger.json`.

Looking at the another file [generic/swagger.json](https://github.com/samchon/nestia/tree/master/demo/generic/swagger.json), you can find that there isn't any problem even when the generic typed DTO interfaces or controller classes come. Furthermore, traveling the `description` properties of the [generic/swagger.json](https://github.com/samchon/nestia/tree/master/demo/generic/swagger.json), comments written on the generic interfaces and controllers are exactly revived in each route functions and schema definitions.

  - [simple/swagger.json](https://github.com/samchon/nestia/tree/master/demo/simple/swagger.json)
  - [generic/swagger.json](https://github.com/samchon/nestia/tree/master/demo/generic/swagger.json)
  - [union/swagger.json](https://github.com/samchon/nestia/tree/master/demo/union/swagger.json)

<img src="https://github.com/samchon/nestia/wiki/images/swagger-editor-comment.png" width="100%" />

<img src="https://github.com/samchon/nestia/wiki/images/swagger-editor-comment-components.png" width="100%" />
...
> info **Info** Replace detailed contents of the configuration as the Guide Documents.
>
> - [Configuration](https://github.com/samchon/nestia/wiki/Configuration)
>   - [Outline](https://github.com/samchon/nestia/wiki/Configuration#outline)
>   - [Command Line Interface](https://github.com/samchon/nestia/wiki/Configuration#command-line-interface)
>   - [`nestia.config.ts`](https://github.com/samchon/nestia/wiki/Configuration#nestiaconfigts)